...
class JjLogStyleHighlighter(private val project: Project) : VcsLogHighlighter {
    ...
    override fun getStyle(
        ...
        val fg: Color? = if (isConflicted) CONFLICT_FG else null
        val textStyle = if (isPlaceholder) VcsLogHighlighter.TextStyle.ITALIC else VcsLogHighlighter.TextStyle.NORMAL
